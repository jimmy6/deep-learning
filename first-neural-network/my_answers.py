...
#         print("hidden_inputs ", hidden_inputs)
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        flatten_weights_hidden_to_output = np.reshape(self.weights_hidden_to_output, (np.product(self.weights_hidden_to_output.shape),))                
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = error * flatten_weights_hidden_to_output
#         print("flatten_weights_hidden_to_output ",flatten_weights_hidden_to_output)
...
#         print("(hidden_outputs * output_error_term)[:, None] ", (hidden_outputs * output_error_term)[:, None] )
...
#         print("self.lr * delta_weights_h_o ", self.lr * delta_weights_h_o)
#         print("delta_weights_h_o ", delta_weights_h_o)
